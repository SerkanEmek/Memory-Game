...
import com.serkanemek.memorygame.util.AnimationForKeyboard;
import com.serkanemek.memorygame.util.MemoryNumbers;
import com.serkanemek.memorygame.mediaplayer.MyMediaPlayerForBackground;
import com.serkanemek.memorygame.mediaplayer.MyMediaPlayerForCorrectAnswer;
import com.serkanemek.memorygame.mediaplayer.MyMediaPlayerForLast5Min;
                    ...
                    try {
                        secondCountDownTimer = new CountDownTimer(15_000,1_000) {
                            ...
                            public void onFinish() {
                                ...
                                counterForLevel = 0;
                                showTextViewLevel = 1;
                                AlertDialog.Builder builderForFinish = new AlertDialog.Builder(MemoryGameActivity.this);
                                ...
                                dialogforfinish.getWindow().setBackgroundDrawableResource(R.drawable.dialogwrong_next_english);
                            }
